...
- OS error respones ([permission denied](#permissiondenied-config), [disk error](#diskerror-config), [commmand not found](#commandnotfound-config), [file not found](#filenotfound-config), [not implemented](#notimplemented-config)) to [configurable commands](#command-responses)
